...
|---|------|-------|-----------|--------------|
| 1.1 | [I] | resultados.tex, L30 | Citacao duplicada: "as evidencias obtidas por \citeonline{MendesResende2014} e \citeonline{MendesResende2014} apontam em direcao contraria". O mesmo autor e citado duas vezes no mesmo trecho, sugerindo que deveria haver dois autores distintos (provavelmente MendesResende2014 e ResendeSilvaFilho2017 ou CravoResende2015). | Verificar qual par de estudos se pretendia comparar e corrigir a segunda citacao. |
...
| 3.6 | [M] | resultados.tex, L28 | Paragrafo sobre modelos espaciais (MendesResende2014) excede 200 palavras. | Dividir apos a descricao do resultado setorial. |
...
| 5.6 | [I] | resultados.tex, L30 | Citacao duplicada identica no mesmo trecho: `\citeonline{MendesResende2014} e \citeonline{MendesResende2014}`. Provavelmente uma das citacoes deveria ser outro autor. | Corrigir a segunda citacao para o autor pretendido (possivelmente CravoResende2015). |
...
5. **Corrigir citacao duplicada identica** (1.1, 5.6). Na linha 30, `\citeonline{MendesResende2014} e \citeonline{MendesResende2014}` deve referenciar dois autores distintos.
