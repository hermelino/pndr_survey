...
Uma característica distintiva dos FCs é que a previsão constitucional confere aos FCs um fluxo seguro de recursos financeiros, sem contingenciamentos e livre de fatores conjunturais, diferenciando-os dos demais mecanismos de política regional. Os recursos são provenientes de uma parcela da arrecadação nacional de IR e IPI.  Conforme a Tabela~\ref{tab:resumo_fc}, no período 2002--2021, as aplicações acumuladas totalizaram R\$ 323,1 bilhões no FNE, R\$ 129,7 bilhões no FCO e R\$ 96 bilhões no FNO (valores de 2020).
