...
Painel Espacial
	...
	& \fc[2cm]{\item NE \item 2010-2021}
	& \fcvar{\item FDNE (\textit{dummy}) \item Cresc. PIB pc}
	& \fc[4.5cm]{
	...
	\cline{4-5}
	& & 
	& \fcvar{\item FDNE (\textit{dummy}) \item Cresc. VAB pc}
	& \fc[4.5cm]{
...
DID Dois Estágios
	...
	& \fcvar{\item FDNE \item log PIB\textit{pc}, VAB setorial}
	& \fc[4.5cm]{
...
DID Escalonado
	...
	& \fcvar{\item FDNE \item PIB\textit{pc}, emprego, renda, IDEB}
	& \fc[4.5cm]{
	...
	& \fcvar{\item FDNE-parques eólicos \item PIB\textit{pc}, VAB, emprego, massa salarial}
	& \fc[4.5cm]{
...
Painel Dinâmico GMM
	...
	& \fcvar{\item FDNE, FDA, FDCO (+ FC + IF) \item PIB\textit{pc}, emprego, renda}
	& \fc[4.5cm]{
