...
Painel de Efeito Fixo
	...
	& \fcvar{\item FC/PIB \item Cresc. PIB pc}
	& \fc[4.5cm]{
...
Modelo de \textit{Spillover} Espacial
	...
	& \fcvar{\item Log. FCO \item Log. PIB pc}
	& \fc[4.5cm]{
	...
	& \fcvar{\item Log. FC \item Log. PIB pc}
	& \fc[4.5cm]{
...
Equilíbrio Geral
	...
	& \fcvar{\item Fundo \item Log. PIB pc}
	& \fc[4.5cm]{
...
RDD Geográfico
	...
	& \fcvar{\item Log. FNE \item Log. PIB pc}
	& \fc[4.5cm]{
...
\textit{Propensity Score}
	...
	& \fcvar{\item FNE \item Log. PIB pc}
	& \fc[4.5cm]{
...
DID 2 Estágios, DID Escalonado
	...
	& \fcvar{\item FNE (\textit{dummy}) \item Log. PIB pc}
	& \fc[4.5cm]{
